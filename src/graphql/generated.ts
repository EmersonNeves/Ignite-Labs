...
export const GetLessonSlugDocument = gql`
  ...
  lesson(where: {slug: $slug}) {
    ...
    `;
export type GetLessonSlugProps<TChildProps = {}, TDataName extends string = 'data'> = {
      [key in TDataName]: ApolloReactHoc.DataValue<GetLessonSlugQuery, GetLessonSlugQueryVariables>
    } & TChildProps;
export function withGetLessonSlug<TProps, TChildProps = {}, TDataName extends string = 'data'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  GetLessonSlugQuery,
  GetLessonSlugQueryVariables,
  GetLessonSlugProps<TChildProps, TDataName>>) {
    return ApolloReactHoc.withQuery<TProps, GetLessonSlugQuery, GetLessonSlugQueryVariables, GetLessonSlugProps<TChildProps, TDataName>>(GetLessonSlugDocument, {
      alias: 'getLessonSlug',
      ...operationOptions
    });
};

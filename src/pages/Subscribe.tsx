    ...
    <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center">
      <div className="w-full max-w-[1100px] flex items-center justify-between mt-20 mx-auto">
        ...
        <div className="p-8 bg-gray-600 border border-gray-500 rounded">
          ...
          >
            <input
              className="bg-gray-900 rounded px-5 h-14 focus:text-gray-200 outline-none focus:ring focus:border-gray-200"
              type="text"
            ...
            />
            <input
              className="bg-gray-900 rounded px-5 h-14 outline-none focus:ring focus:border-gray-200"
              type="email"
            ...
            {!loading ? (
              ...
              >
                <svg
                  className="motion-safe:animate-spin h-5 m-auto ..."
                  viewBox="0 0 30 30"
                >
                  <Spinner size={30} />
                </svg>
